    ...
    <div className="space-y-6">
      {!results && !applying && (
        <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-6 text-center">
          ...
          <div className="bg-amber-950/40 border border-amber-700/50 rounded-lg px-4 py-3 mb-4 text-left max-w-md mx-auto">
            <div className="flex items-start gap-2 text-amber-400 text-sm">
              <AlertTriangle size={16} className="mt-0.5 shrink-0" />
              <p className="text-slate-400"><span className="text-amber-400 font-medium">Heads up:</span> Updating table or column comments creates a Delta transaction commit. Running ETL pipelines (DLT, jobs) may pick this up and trigger a reprocess. If these tables are part of an active pipeline, consider applying during a maintenance window or when the pipeline is idle.</p>
            </div>
          </div>
